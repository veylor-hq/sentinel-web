...
export default function MissionsPage() {
  ...
  return (
    <div className="bg-black text-white h-min w-full flex flex-col">
      {/* Header */}
      ...
      {/* Kanban / Sections */}
      <div className="flex-1 p-4 md:p-6 grid grid-cols-1 gap-6 md:flex md:gap-4 md:overflow-x-auto min-h-0">
        {COLUMNS.map((col) => {
          ...
          return (
            <div
              key={col.key}
              className="flex-1 min-w-full md:min-w-[250px]  md:max-w-sm bg-black-900 border border-black-800 rounded-lg flex flex-col min-h-0"
            >
              {/* Column Header */}
              <div className="p-3 border-b border-black-700 flex items-center gap-2">
